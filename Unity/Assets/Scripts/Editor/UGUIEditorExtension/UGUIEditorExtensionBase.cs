...
/// </summary>
public abstract class UGUIEditorExtensionBase : UnityEditor.Editor
{
    ...
    private static Assembly editorAssembly = Assembly.GetAssembly(typeof(ImageEditor));
	...
	public UGUIEditorExtensionBase (string editorTypeName)
	{
